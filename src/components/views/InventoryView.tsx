    ...
    reader.onload = (evt) => {
      try {
        ...
        jsonData.forEach((row, idx) => {
          ...
          const rowSku = getFlexVal(row, ['SKU', 'Sku', 'Codigo_Interno', 'Cod_Interno', 'Referencia']) || ('MED-' + (products.length + idx + 1).toString().padStart(3, '0'));
          ...
          const rowGeneric = getFlexVal(row, ['Nombre_Generico', 'Generico', 'Principio_Activo']) || rowName;
          const rowCatName = getFlexVal(row, ['Categoria', 'Rubro', 'Clase']) || 'General';
